...
@enderror
    ...
    <div class="content">
        ...
        <form class="col-md-12" action="{{route('products.add')}}" method="POST" enctype="multipart/form-data">
            @csrf                                      
            <div class="card">
                <div class="card-header">
                    <h5 class="title">Products ADD</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="num" name="price" class="form-control" placeholder="" value="">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="num" name="quantity" class="form-control" placeholder="" value="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="col-md-6 col-form-label">Products Brands</label>
                                <input type="text" name="brands" class="form-control" placeholder="" value="">
                            </div>
                        </div>  
                        <div class="col-md-6">
                            <div class="form-group">
